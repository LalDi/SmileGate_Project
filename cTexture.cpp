...
void cTexture::Render(POINT pos, RECT rect, POINT size, float rot, D3DCOLOR color)
{
	IMAGEMANAGER->Render(this, pos.x, pos.y, rect, size, rot, color);
}
...
void cTexture::CenterRender(POINT pos, RECT rect, POINT size, float rot, D3DCOLOR color)
{
	IMAGEMANAGER->CenterRender(this, pos.x, pos.y, rect, size, rot, color);
}
