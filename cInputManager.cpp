...
INT cInputManager::Update()	// Mouse
{
	INT i = 0;
...
BOOL cInputManager::KeyDown(INT nKey)
{
	return m_KeyMap[nKey] == EINPUT_DOWN;
}

BOOL cInputManager::KeyUp(INT nKey)
{
	return m_KeyMap[nKey] == EINPUT_UP;
}

BOOL cInputManager::KeyPress(INT nKey)
{
	return m_KeyMap[nKey] == EINPUT_PRESS;
}

INT cInputManager::KeyState(INT nKey)
{
	return m_KeyMap[nKey];
}

// Mouse
BOOL cInputManager::BtnDown(INT nBtn)
{
	return m_BtnMap[nBtn] == EINPUT_DOWN;
}

BOOL cInputManager::BtnUp(INT nBtn)
{
	return m_BtnMap[nBtn] == EINPUT_UP;
}

BOOL cInputManager::BtnPress(INT nBtn)
{
	return m_BtnMap[nBtn] == EINPUT_PRESS;
}

INT cInputManager::BtnState(INT nBtn)
{
...
POINT cInputManager::GetMouseEps()
{
	return m_vcEps;
}
